...
<body>
    ...
    <section class="home-section">
        ...
        <div class="content-deposite">
            <div class="container">
                <h5 class="display-4">Diskon & Komplemen</h5>
            </div>
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <table id="tabledeposit" class="table table-striped table-bordered" style="width:100%">
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    <td>{{$data->nomor}}</td>
                                    <td>{{$data->discount_complement_name}}</td>
                                    <td>{{$data->discount_complement_type}}</td>
                                    <td>{{$data->amount}}</td>
                                    <td>{{$data->discount_complement_rank}}</td>
                                    <td>{{$data->period_id}}</td>
                                    <td>{{$data->discount_complement_notes}}</td>
                                    <!-- <td>
                                ...
                                <!-- <tr>
                                    <td>2</td>
                                    <td>Diskon fasilitas GYM</td>
                                    <td>Diskon</td>
                                    <td>30%</td>
                                    <td>1</td>
                                    <td>3</td>
                                    <td>Diskon ini berlaku untuk selamanya</td>
                                    <td>
                                        <a href=""><button type="button" class="btn btn-custom">Update</button></a>
                                    </td>
                                </tr> -->
