                        ...
                        <table id="tabledeposit" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=""><button type="button" class="btn btn-custom2">Detail</button></a>
                                        <a href="{{URL::to('/tagihan/edit/'.$data->transation_id)}}"><button type="button"
                                                class="btn btn-custom">Update</button></a>
                                        <a href=""><button type="button" class="btn btn-custom3">Print</button></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
